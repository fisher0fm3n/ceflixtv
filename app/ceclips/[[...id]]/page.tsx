  ...
  function Player({
    ...
    return (
      <div className="h-full w-full bg-black">
        <div className="flex h-full w-full items-center justify-center px-2 md:px-6">
          <div className="relative flex h-full w-full items-center justify-center">
            <div className="relative h-[100svh] w-full max-w-[430px] overflow-hidden rounded-none bg-black md:h-[calc(100svh-110px)] md:rounded-2xl">
            ...
            <div className="absolute right-2 bottom-32 z-50 flex flex-col items-center gap-4 text-white md:right-[max(calc(50%-295px),1rem)] md:bottom-16">
              <button
                type="button"
                onClick={onLike}
